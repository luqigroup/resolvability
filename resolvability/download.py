...
``checkpoints``  the trained priors: three seeds per prior for the seismic and groundwater
...
REGISTRY: dict[str, tuple[str, str]] = {
    ...
    "results/darcy_borehole.npz":
        ("data", "https://www.dropbox.com/scl/fi/i2z4b3bal43yqarm4vow7/darcy_borehole.npz?rlkey=3k319qqb15tpzha15a507c8nc&dl=1"),
    ...
    "results/seismic_illum_diag.npz":
        ("data", "https://www.dropbox.com/scl/fi/ffs2fif0uw5iswu10nk31/seismic_illum_diag.npz?rlkey=hkkxurtkibwi5sd6odgrakabn&dl=1"),
    ...
    # --- checkpoints: the groundwater flows, three seeds per prior plus the jointly curated one ---
    ...
    "data/darcy/darcy_dataset.h5":
        ("data", "https://www.dropbox.com/scl/fi/yertgug9s4oj9d1sliim0/darcy_dataset.h5?rlkey=zbvpjmr7dg4jwdpisrrxwvdq1&dl=1"),
