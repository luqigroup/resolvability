...
Big field galleries only -- the train/val NLL curves live in fig_darcy_loss.py. Loads each prior's
...
def main():
    with h5py.File(ensure("data/darcy/darcy_dataset.h5"), "r") as f:
