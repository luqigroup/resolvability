...
unconditional samples from each prior's seed-0 checkpoint and shows them beside real training
...
KEY = {"curated": "lsrtm5", "oracle": "broadband_dm"}              # training target of each prior
