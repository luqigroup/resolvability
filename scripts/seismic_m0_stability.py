...
def background(n, vtop=2.5, vbot=4.5, water=1.5, water_cells=None, tilt=0.0):
    """The paper's background, with the knobs a migration velocity analysis would actually move."""
...
def phase_stability(n, P, nb):
    ...
    print("\nsaved results/seismic_m0_stability.npz")
...
def phase_diag(n, sep, step):
    ...
    print("saved results/seismic_illum_diag.npz")
