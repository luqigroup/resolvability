...
EPOCHS, LR = 5, 150.0
# Soft-threshold strength for the archive's sparsity-promoting run, in the AdaGrad metric. Set at
...
def adagrad_lsrtm(im, d_obs, rng, l1_lam=L1_LAMBDA):
    ...
    for that diagonal metric. With ``l1_lam = 0`` this is the plain early-stopped run, whose
