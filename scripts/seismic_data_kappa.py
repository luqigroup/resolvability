#!/usr/bin/env python
"""Measurement-only amplitude calibration for the two seismic priors.
...
pipeline in practice actually has: each sample set is placed at the amplitude at which its SIMULATED
