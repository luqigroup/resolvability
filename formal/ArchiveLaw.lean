...
This file machine-checks **Theorem 1** ("A legacy archive is one EM step from the
...
#print axioms ArchiveLaw.pLaw_partB
#print axioms ArchiveLaw.comp_curatedPrior_eq_withDensity
